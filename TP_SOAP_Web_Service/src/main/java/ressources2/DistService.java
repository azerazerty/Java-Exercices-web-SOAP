...
public interface DistService {
    ...
    @RequestWrapper(localName = "CalcDistance", targetNamespace = "http://distservice.dz/", className = "ressources2.CalcDistance")
    @ResponseWrapper(localName = "CalcDistanceResponse", targetNamespace = "http://distservice.dz/", className = "ressources2.CalcDistanceResponse")
